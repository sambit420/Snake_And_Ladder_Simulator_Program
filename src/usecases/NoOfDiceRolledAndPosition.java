...
public class NoOfDiceRolledAndPosition {
    NoOfDiceRolledAndPosition() {
        System.out.println("Welcome to Snake and Ladder Simulation \n");
    }

    public static void main(String[] args) {
        useCases.RepeatTillThePlayerReachesTheExactWinningPosition a = new useCases.RepeatTillThePlayerReachesTheExactWinningPosition();
